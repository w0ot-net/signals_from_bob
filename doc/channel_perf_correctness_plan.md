...
5) Validation and documentation.
   - Run unit or module-level tests that cover channel open/close, control
     message handling, and send/recv buffer limits.
   - Do not run tests/e2e; note this in the change summary.
   - Update doc/CHANNEL.md and doc/CHANNEL_MANAGER.md to reflect final
     behavior (close semantics, receive buffer limits).
