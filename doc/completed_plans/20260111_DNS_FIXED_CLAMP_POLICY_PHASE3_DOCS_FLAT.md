...
## Execution Notes
- 2026-01-11: Updated protocol, tunnel, and DNS transport docs to remove POLL_HINT
  references and document the fixed response cap policy.
- 2026-01-11: Reordered `doc/flatten_manifest.txt` to satisfy module ordering
  for the flat build.
- 2026-01-11: Regenerated `sfb_flat.py` via `scripts/flatten.py`.
