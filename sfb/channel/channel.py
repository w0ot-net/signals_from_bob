...
class Channel(object):
    ...
    def _get_state(self):
        """Return current state (internal helper)."""
        with self._state_lock:
            return self.state
    ...
    def _set_state_locked(self, state, error=None, error_code=None,
                          drop_buffers=False):
        """Set channel state. Must hold state lock."""
        notify = None
        self.state = state
